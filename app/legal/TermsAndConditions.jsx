...
const TermsAndConditions = () => (
	<LegalPageLayout title="Terms and Conditions">
		...
		<LegalParagraph>
			...
			Use for access or usage of domain name https://inkgest.com (&apos;Website&apos;),
		...
		<LegalParagraph>
			...
			herein by way of reference. If You transact on the Platform, You shall be
			...
			conditions proposed by You which are in addition to or which conflict with
			these Terms of Use are expressly rejected by the Platform Owner and shall
			be of no force or effect. These Terms of Use can be modified at any time
		...
		<LegalParagraph>
			...
			&apos;you&apos;, &apos;your&apos; or &apos;user&apos; shall mean any
		...
		<LegalParagraph>
			...
			such third party websites. These links are provided for your convenience
