...
const RefundPolicy = () => (
	<LegalPageLayout title="Refund Policy">
		...
		<LegalParagraph>
			Cancellations will only be considered if the request is made 15 days of
			placing the order. However, cancellation requests may not be entertained if
			the orders have been communicated to such sellers / merchant(s) listed on
			the Platform and they have initiated the process of shipping them, or the
			product is out for delivery. In such an event, you may choose to reject the
		...
		<LegalParagraph>
			...
			merchant listed on the Platform, has checked and determined the same at its
			own end. This should be reported within 15 days of receipt of products. In
			...
			service within 15 days of receiving the product. The customer service team
			after looking into your complaint will take an appropriate decision.
		</LegalParagraph>
		<LegalParagraph>
			In case of complaints regarding the products that come with a warranty from
